package com.adebusoye.JOptionPane_58;
...
public class Main {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "This is a message dialog box", "Toheeb Dialog", JOptionPane.PLAIN_MESSAGE);
        ...
        ImageIcon icon = new ImageIcon("C:\\Users\\MR AKINADE AA\\IdeaProjects\\Java_Syntax_MiniProject\\src\\main\\java\\com\\adebusoye\\JOptionPane_58\\img.png");
