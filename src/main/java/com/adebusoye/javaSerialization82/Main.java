package com.adebusoye.javaSerialization82;
...
class SerializeDemo {
    ...
    public static void main(String [] args) {
        ...
        user.name = "Bro Toheeb";
        user.password = "I<3Pizza22";

        //user.hello();

        try {
            FileOutputStream fileOut = new FileOutputStream("C:\\Users\\MR AKINADE AA\\IdeaProjects\\Java_Syntax_MiniProject\\src\\main\\java\\com\\adebusoye\\javaSerialization82\\UserInfo.ser");
...
class Deserialize {
    ...
    public static void main(String [] args) {
        ...
        try {
            fileIn = new FileInputStream("C:\\Users\\MR AKINADE AA\\IdeaProjects\\Java_Syntax_MiniProject\\src\\main\\java\\com\\adebusoye\\javaSerialization82\\UserInfo.ser");
